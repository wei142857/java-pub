...
public final class HttpUtils {
	...
	static {
		...
		else if (ClassUtils.isPresent("pay.ext.kit.HttpKit", HttpUtils.class.getClassLoader())) {
	...
	private static class HttpKitDelegate implements HttpDelegate {
		...
		@Override
		public String get(String url) {
			return pay.ext.kit.HttpKit.get(url);
		}

		@Override
		public String get(String url, Map<String, String> queryParas) {
			return pay.ext.kit.HttpKit.get(url, queryParas);
		}

		@Override
		public String post(String url, String data) {
			return pay.ext.kit.HttpKit.post(url, data);
		}

		@Override
		public String post(String url, Map<String, String> queryParas) {
			return pay.ext.kit.HttpKit.post(url, queryParas, "null");
		}
