...
public class AliPayApi {
	 ...
	 * @throws {IOException}
	 */
	public static String wapPay(Response response, AlipayTradeWapPayModel model,String returnUrl,
	 ...
	 * @throws {IOException}
	 */
	public static String wapPayStr(AlipayTradeWapPayModel model,String returnUrl,
			String notifyUrl) throws AlipayApiException, IOException {
	 ...
	 */
	public static Map<String, String> toMap(play.mvc.Http.Request request) {
	...
	public static boolean tradeStatusIsOk(String trade_status){
		return StrKit.notBlank(trade_status) && "TRADE_SUCCESS".equals(trade_status);
	}
