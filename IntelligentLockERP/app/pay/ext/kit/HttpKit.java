...
public class HttpKit {
	...
	public static String readData(play.mvc.Http.Request request) {
		String bodyMsg = request.body().toString();
		int start = bodyMsg.indexOf("<xml>");
		int end = bodyMsg.indexOf("</xml>", start)+6;
		return bodyMsg.substring(start,end);
	}
